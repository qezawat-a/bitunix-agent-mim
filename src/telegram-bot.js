...
export async function setCommands() {
  ...
  const commands = [
    ...
    { command: 'autonomous', description: 'autonomous on|off' },
    { command: 'leverage', description: 'Set leverage' },
    { command: 'symbol', description: 'Set symbol' },
    { command: 'marginmode', description: 'crossed|isolated' },
    { command: 'positionmode', description: 'hedge|one_way' },
    ...
    { command: 'memory', description: 'List, get, set, clear memory' },
    { command: 'connect', description: 'Provider, model and key' },
